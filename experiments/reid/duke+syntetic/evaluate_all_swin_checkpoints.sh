...
checkpoint_dir=/mnt/2tb_ssd/TwinProject/experiments/reid/duke+syntetic/results_swin_combined/train
results_dir=/mnt/2tb_ssd/TwinProject/experiments/reid/duke+syntetic/evaluation_results_swin_combined
mkdir -p "$results_dir"
