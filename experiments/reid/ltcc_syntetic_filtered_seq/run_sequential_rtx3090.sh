...
CONTAINER_NAME=${CONTAINER_NAME:-tao_ltcc_filtered_syntetic_seq_gpu0}
EPOCHS=${EPOCHS:-150}
...
cmd+=(
  ...
  -e "$EXP/configs/ltcc_filtered_syntetic.yaml"
  'train.gpu_ids=[0]'
  'evaluate.gpu_ids=[0]'
)

echo "Starting LTCC + filtered synthetic sequential training on RTX 3090 / GPU0."
echo "Config: $EXP/configs/ltcc_filtered_syntetic.yaml"
